...
class _OsirisEyePainter extends CustomPainter {
  ...
  void _drawTextOnLine(Canvas canvas, String text, Offset start, Offset end, double fontSize) {
    ...
    final textPainter = TextPainter(textSpan: textSpan, textDirection: TextDirection.ltr); textPainter.layout(); textPainter.paint(canvas, Offset(-textPainter.width / 2, -textPainter.height - 2)); canvas.restore();
  }
