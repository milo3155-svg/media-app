...
// ==========================================
// GESTOR DE REPRODUCCIÓN PERSISTENTE GLOBAL
// ==========================================
class YMusicPlayerProvider extends ChangeNotifier {
  ...
  Future<void> playItem(MediaItemModel item) async {
    ...
    // 2. Si es YouTube
      ...
      await _audioPlayer.stop();
      final String targetUrl = 'https://www.youtube.com/embed/${item.id}?autoplay=1';
...
// ==========================================
// REPRODUCTOR DETALLADO CON WEBVIEW CONECTADO
// ==========================================
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            if (item.directStreamUrl == null && playerProvider.webViewController != null)
              Container(
                height: 230,
